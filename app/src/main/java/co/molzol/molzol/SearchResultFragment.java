...
public class SearchResultFragment extends Fragment {
    ...
    private class AsyncRest extends AsyncTask<Void, Void, Products> {

        @Override
        protected Products doInBackground(Void... params) {

            Products products = Flipkart.searchProducts(query, count);
        ...
        protected void onPostExecute(Products products) {
            ...
            searchResultAdapter.setProducts(products);
